...
-- #[toasty::breakpoint]
INSERT INTO "_toasty_new_regions" ("id", "name", "geometry", "notes", "category", "created_at", "updated_at") SELECT "id", "name", "geometry", "notes", "category", "created_at", "updated_at" FROM "regions";
-- #[toasty::breakpoint]
DROP TABLE "regions";
-- #[toasty::breakpoint]
