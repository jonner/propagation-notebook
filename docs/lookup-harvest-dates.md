...
- Before starting, it would be nice to know the current status of the harvest dates in the DB
...
- it would be nice to know the common name(s) of the taxon in inaturalist when choosing which one is associated with the local taxon
